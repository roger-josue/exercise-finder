...
export default function Landing() {
    ...
    return (
        <section className="relative overflow-hidden min-h-[65vh] xl:min-h-screen w-full flex flex-col max-lg:justify-center items-start gap-8 mb-16 xl:mb-0">
            ...
            <motion.figure animate={{x: -1300, y: 400, rotate: 180}} transition={{repeat: Infinity, duration: 15, repeatType: "mirror", ease: "linear"}} className="block xl:hidden absolute bg-secondary bg-opacity-10 top-4 -right-40 w-40 h-40 z-0 fancy-radius-1 pointer-events-none"></motion.figure>
            <motion.figure animate={{x: 1300, y: -400, rotate: 180}} transition={{repeat: Infinity, duration: 15, repeatType: "mirror", ease: "linear", delay: 6}} className="block xl:hidden absolute bg-secondary bg-opacity-10 bottom-20 -left-40 w-40 h-40 z-0 fancy-radius-3 pointer-events-none"></motion.figure>
            <motion.figure animate={{x: 1300, y: 400, rotate: 180}} transition={{repeat: Infinity, duration: 15, repeatType: "mirror", ease: "linear", delay: 4}} className="block xl:hidden absolute bg-primary bg-opacity-10 top-20 -left-40 w-40 h-40 z-0 fancy-radius-2 pointer-events-none"></motion.figure>
            <motion.figure animate={{x: -1300, y: -200, rotate: 180}} transition={{repeat: Infinity, duration: 15, repeatType: "mirror", ease: "linear", delay: 7}} className="block xl:hidden absolute bg-primary bg-opacity-10 bottom-24 -right-40 w-40 h-40 z-0 fancy-radius-4 pointer-events-none"></motion.figure>
        </section>
    )
}